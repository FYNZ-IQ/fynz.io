...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-2xl px-4.5 py-2.5 text-sm font-medium transition-all outline-none bg-transparent text-slate-600 dark:text-slate-300 hover:bg-transparent hover:text-copper focus:bg-transparent focus:text-copper focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-transparent data-popup-open:text-copper data-open:bg-transparent data-open:text-copper data-open:hover:bg-transparent data-open:focus:bg-transparent"
)
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-1.5 rounded-2xl p-3 text-sm transition-all outline-none bg-transparent text-slate-600 dark:text-slate-300 hover:bg-transparent hover:text-copper focus:bg-transparent focus:text-copper focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-xl data-[active=true]:bg-transparent data-[active=true]:text-copper [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
