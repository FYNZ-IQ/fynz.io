// Copy and structured data for /industries/restaurants. Kept outside the
...
export const RESTAURANT_PLANS: Plan[] = [
  ...
  },
  {
    ...
    href: "/onboarding?plan=launch&industry=restaurants",
  },
  {
    key: "growth",
    name: "Growth",
    ...
    cta: "Start on Growth",
    href: "/onboarding?plan=growth&industry=restaurants",
    popular: true,
  },
  {
    key: "managed",
