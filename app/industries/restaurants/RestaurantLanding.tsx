...
function CtaStrip({ title, body, showFree = true }: { title: string; body?: string; showFree?: boolean }) {
  return (
...
function DarkCard({ children, className, highlight = false }: { children: React.ReactNode; className?: string; highlight?: boolean }) {
  return (
  ...
  return (
    <footer className="py-10 border-t border-line-soft">
      <div className="max-w-3xl mx-auto px-5 sm:px-6 text-center">
        <p className="text-xs text-faint leading-relaxed max-w-2xl mx-auto">
